...
class CampaignSubscriber extends CommonSubscriber
{
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            'executeSendAlertAction'          => ['executeSendAlert', 0],
        ];
    }
     ...
     * @return string
     */
    public function generatePropertiesPlainText($properties = [])
    {
        $propertiesPlain = '';
     ...
     * @return string
     */
    public function replaceTokensContent(Email $email, $leadProperties=[])
    {
...
//        $this->mailer->parsePlainText();
        ...
        error_log(json_encode(['send result'=>$send]));
