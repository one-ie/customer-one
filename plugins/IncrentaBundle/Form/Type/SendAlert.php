...
namespace MauticPlugin\IncrentaBundle\Form\Type;
 ...
 * Class CampaignType.
 */
class SendAlert extends AbstractType
{
    ...
    {
        $builder->add('sendto', 'text', [
            'label'      => 'plugin.increnta.form.field.sendto',
