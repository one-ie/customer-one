...
class SmsreaderController extends CommonController
{
    ...
    public function indexAction()
    {
        ...
        if (array_key_exists('unsubscribeKeywords', $config)) {
            $config['unsubscribeKeywords'] = implode(',', $config['unsubscribeKeywords']);
        }
        if (array_key_exists('resubscribeKeywords', $config)) {
            $config['resubscribeKeywords'] = implode(',', $config['resubscribeKeywords']);
        }
